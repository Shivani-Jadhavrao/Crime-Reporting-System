...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class='head'>
  <h1 class='company'>Police Login</h1>
  </div>
  <div class='form'>
    <form method="post" action="policelogincheck.php">
  <input type="text" placeholder='Username' required class='text' name=uid id='username' style="font-size:18px;  font-family: Bookman Old Style;" required><br>
