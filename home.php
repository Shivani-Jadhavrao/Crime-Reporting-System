...
<!-- Header -->
<header class="w3-container" style="padding:36px 25px;background-image:url(home.jpg);background-size:100%;background-repeat:no-repeat;">
  <h1 class="w3-margin w3-jumbo" style="font-weight:bold; letter-spacing:-4;font-style:italic">It's Our Pride To Serve You!!</h1>
  <button><a href="complainer_page.php">File Complaint</a></button>
</header>
  ...
  <div class="w3-content">
    ...
    <div class="w3-twothird">
	 ...
	 As Constable Apply in DPO office Gujrat after advertisement in the press. Terms and conditions and the procedure will be mentioned in the ad.
				...
				As ASP apply through Federal Public Service Commission In competitive examination for Central Superior Services, terms and conditions and procedure is mentioned in the ad. And FPSC rules and regulation.
