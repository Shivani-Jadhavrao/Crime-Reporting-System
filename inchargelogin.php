...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class='head'>
  <h1 class='company'>Incharge Login</h1>
  </div>
  <div class='form'>
    <form method="post" action="inchargelogincheck.php">
  <input type="text" placeholder='Username' class='text' required name=uid id='username' style="font-size:18px;  font-family: Bookman Old Style;" required><br>
  <input type="password" placeholder='••••••••••••••' required name=pswd style="font-size:18px;  font-family: Bookman Old Style;" class='password'><br>
